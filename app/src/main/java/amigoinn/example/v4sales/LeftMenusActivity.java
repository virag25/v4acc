...
//				DrawerItem.DRAWER_ITEM_TAG_GIT_HUB));
		mDrawerItems.add(new DrawerItem(R.string.drawer_icon_Share,R.string.drawer_title_REPORTS ,DrawerItem.DRAWER_ITEM_TAG_INSTAGRAM));
		mDrawerItems.add(new DrawerItem(R.string.drawer_icon_Share,R.string.drawer_title_RankFinal ,DrawerItem.DRAWER_ITEM_TAG_INSTAGRAM));
//		mDrawerItems.add(new DrawerItem(R.string.drawer_icon_Share,
...
//				212.131.115.219/navkarmobileservice/
				Fragment fragment1234 = new AbsentList();//.newInstance();
